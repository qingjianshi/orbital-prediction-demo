...
from orbit_prediction_30days_wgs84 import Tle_Requests,OrbitCal

if __name__ == "__main__":
    pd.set_option('display.encoding', 'utf-8')
    tle_now2=Tle_Requests()
    tle_now2.tle_requests_totxt()
    ...
    # engine=OrbitCalTest2.CreateConnection(database_name='postgres', database_username='postgres', database_password='ecnu2024',
    #                           database_host='49.52.31.105', database_post='5434')
    engine= OrbitCalTest2.CreateConnection(database_name='postgres', database_username='postgres', database_password='sunjin123',database_host='43.128.24.169',database_post='5435')
    OrbitCalTest2.crawl_satellite_data(start_time_interval=29,end_time_interval=1,delete_data=True)
